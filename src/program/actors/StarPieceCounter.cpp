...
//    if (al::isActionEnd(this, 0)) { //Si l'action Appear est terminé
//        al::setNerve(this, &nrvStarPieceCounter.Wait); //Nerve sur exeWait()
//    }
//}
//
...
//{
//    al::startAction(this, "Appear", 0); // Commence l'animation Appear du Layout
//    al::setNerve(this, &nrvStarPieceCounter.Appear); //Nerve sur exeAppear()
//
